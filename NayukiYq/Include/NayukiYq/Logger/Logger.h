...
#include <NayukiYq/Misc/Singleton.h>
...
class NAYUKIYQ_API LoggerCategory {
  public:
  ...
  private:
    friend bool operator==(const LoggerCategory &LHS,
                           const LoggerCategory &RHS) {
...
class NAYUKIYQ_API Logger : public Singleton<Logger> {
  public:
  ...
  private:
    ...
    CreateSyncLogger(const LoggerCategory &loggerCategory);
    std::shared_ptr<spdlog::logger>
    CreateAsyncLogger(const LoggerCategory &loggerCategory);
};
...
#define NY_LOG_CATEGORY_DECLARED(LogCategory)                                  \
    extern const NAYUKIYQ_API LoggerCategory LogCategory;
...
#define NY_LOG(LogCategory, LogLevel, LogInfo, ...)                            \
    {                                                                          \
        auto Logger = Logger::GetInstance().Get(LogCategory);                  \
        if (Logger) {                                                          \
            Logger->LogLevel(LogInfo, __VA_ARGS__);                            \
        }                                                                      \
    }
#endif // !NY_LOG
} // namespace LoggerDetail
...
#ifndef NY_LOG_INFO
#define NY_LOG_INFO(LogCategory, LogInfo, ...)                                 \
    {                                                                          \
        NY_LOG(LogCategory, info, LogInfo, __VA_ARGS__);                       \
    }
#endif // !NY_LOG_INFO

#ifndef NY_LOG_TRACE
#define NY_LOG_TRACE(LogCategory, TEXT, ...)                                   \
    {                                                                          \
        NY_LOG(LogCategory, trace, LogInfo, __VA_ARGS__);                      \
    }
#endif // !NY_LOG_TRACE

#ifndef NY_LOG_DEBUG
#define NY_LOG_DEBUG(LogCategory, LogInfo, ...)                                \
    {                                                                          \
        NY_LOG(LogCategory, debug, LogInfo, __VA_ARGS__);                      \
    }
#endif // !NY_LOG_DEBUG

#ifndef NY_LOG_WARN
#define NY_LOG_WARN(LogCategory, LogInfo, ...)                                 \
    {                                                                          \
        NY_LOG(LogCategory, warn, LogInfo, __VA_ARGS__);                       \
    }
#endif // !NY_LOG_WARN

#ifndef NY_LOG_ERROR
#define NY_LOG_ERROR(LogCategory, LogInfo, ...)                                \
    {                                                                          \
        NY_LOG(LogCategory, error, LogInfo, __VA_ARGS__);                      \
    }
#endif // !NY_LOG_ERROR
