...
export module meta_forge.class_attribute_collector;

import meta_forge.meta_info;
import meta_forge.decl_context_utils;

export inline clang::ast_matchers::DeclarationMatcher ClassMatcher =
    clang::ast_matchers::recordDecl( clang::ast_matchers::isClass(), clang::ast_matchers::isExpansionInMainFile() )
        .bind( "class" );

export class ClassAttributeCollector : public clang::ast_matchers::MatchFinder::MatchCallback
{
  public:
