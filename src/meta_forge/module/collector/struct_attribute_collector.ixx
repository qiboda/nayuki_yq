...
export module meta_forge.struct_attribute_collector;

export inline clang::ast_matchers::DeclarationMatcher StructMatcher =
    clang::ast_matchers::recordDecl( clang::ast_matchers::isStruct(), clang::ast_matchers::isExpansionInMainFile() )
        .bind( "struct" );

export class StructAttributeCollector : public clang::ast_matchers::MatchFinder::MatchCallback
{
  public:
