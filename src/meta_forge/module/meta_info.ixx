...
export enum class ContextPathType : u8 {
    Global = 0,
    Class = 1 << 0,
    Struct = 1 << 1,
    Namespace = 1 << 2,
...
// this is a flag enum.
export inline ContextPathType operator|( ContextPathType c1, ContextPathType c2 )
{
...
export struct META_FORGE_API ContextCombinedPath
{
...
export enum class TypeQualifier : u32 {
    None = 0,
    Volatile = 1 << 0,
    Const = 1 << 1,
...
export struct META_FORGE_API MetaInfo
{
  public:
...
export struct META_FORGE_API PropertyMetaInfo
{
  public:
    MetaInfo mMetaInfo;
 ...
 * TODO: 多处包含，如何排除？
 */
export struct META_FORGE_API ValueMetaInfo
{
  public:
    MetaInfo mMetaInfo;
...
export struct META_FORGE_API FunctionParam
{
    std::string mName;
};

export struct META_FORGE_API FunctionMetaInfo
...
export struct META_FORGE_API MethodParam
{
    std::string mName;
};

export struct META_FORGE_API MethodMetaInfo
{
  public:
    MetaInfo mMetaInfo;
...
export struct META_FORGE_API ParentMetaInfo
{
    MetaIdGenerator::MetaIdType mId;
    std::string mAccessLevel;
};

export struct META_FORGE_API StructMetaInfo
{
  public:
    MetaInfo mMetaInfo;
...
export struct META_FORGE_API ClassMetaInfo
{
  public:
    MetaInfo mMetaInfo;
...
export struct META_FORGE_API EnumMember
{
    std::string mName;
...
export struct META_FORGE_API EnumMetaInfo
{
  public:
    MetaInfo mMetaInfo;
...
export struct META_FORGE_API MetaInfoUniqueKey
{
    std::string mFilePath;
...
export struct META_FORGE_API MetaInfoManager
{
  public:
