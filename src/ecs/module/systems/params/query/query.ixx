...
export module ecs.systems.params.query;
...
{
  public:
    void Init( IRegistryContext* registry )
    {
        mRegistry = registry;
  ...
  protected:
    ...
    IRegistryContext* mRegistry = nullptr;
};
...
class Query : public SystemParam
{
  ...
  public:
    ...
    static Query<T...> From( IRegistryContext* registry, State* state )
    {
