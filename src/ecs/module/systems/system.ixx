...
export class ECS_API ISystem : public NonCopyable
{
  ...
  public:
    virtual void Run( IRegistryContext* registry ) = 0;
...
class System : public ISystem
{
  public:
    ...
    virtual void Run( IRegistryContext* registry ) override
    {
  ...
  private:
    ...
    constexpr void SetSystemFunc( Func func, std::index_sequence<Index...> )
    {
        ...
        mSystemFunc = [func, this]( IRegistryContext* registry )
        {
    ...
    std::function<void( IRegistryContext* )> mSystemFunc;
